...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jLabel9.setFont(new java.awt.Font("Arno Pro", 1, 36)); // NOI18N
        jLabel9.setText("PLACEMENT SYSTEM");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String sql= "Insert into company (cid,type,cname,cutoff,location,salary,clg_name,ddate) values (?,?,?,?,?,?,?,?)"; 
        try {
        ...
        ob.setVisible(true);
            ...
            JOptionPane.showMessageDialog(null, "ener full details");
